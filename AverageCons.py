...
for row in range(2, average_cons_sheet.max_row + 1):
    sales_202212 = average_cons_sheet.cell(row=row, column=9).value
    sales_202301 = average_cons_sheet.cell(row=row, column=10).value
    sales_202302 = average_cons_sheet.cell(row=row, column=11).value
...
average_cons_workbook.save("3 months Avg.xlsx")
